...
class BantenprovProdukHukumSeeder extends Seeder
{
    ...
    protected $fileName = "BantenprovProdukHukumSeeder.csv";
    ...
    public function __construct(){
        ...
        $this->model = new Bantenprov\ProdukHukum\Models\Bantenprov\ProdukHukum\ProdukHukum;
    ...
    protected function readCSV()
    {
        ...
        while(($data = fgetcsv($file, 1000, ",")) !== FALSE){            
            $all_data[] = ['user_id' => $data[0], 
                            'group_egovernment_id' => $data[1],
                            'sector_egovernment_id' => $data[2],
                            'label' => $data[3],
                            'description' => $data[4],
                            'link' => $data[5],
                        ];
